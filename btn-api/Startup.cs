...
using btn_api._Repositories.Repositories;
using btn_api._Services.Interface;
using btn_api._Services.Services;
using btn_api.Data;
using btn_api.Helpers;
using btn_api.Helpers.AutoMapper;
using btn_api.SignalrHub;
...
namespace btn_api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IBuildingWorkerRepository, BuildingWorkerRepository>();
            services.AddScoped<IButtonRepository, ButtonRepository>();
            services.AddScoped<ILineInfoRepository, LineInfoRepository>();
            services.AddScoped<IWorkerRepository, WorkerRepository>();
            services.AddScoped<IWorkerButtonRepository, WorkerButtonRepository>();

            // db2
            services.AddScoped<IRawDataRepository, RawDataRepository>();
            services.AddScoped<ICycleTimeRepository, CycleTimeRepository>();

            //Services
            services.AddScoped<IBuildingService, BuildingService>();
            services.AddScoped<IButtonService, ButtonService>();
            services.AddScoped<IBuildingWorkerService, BuildingWorkerService>();
            services.AddScoped<IWorkerService, WorkerService>();
            services.AddScoped<ILineInfoService, LineInfoService>();
